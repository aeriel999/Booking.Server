...
namespace Booking.Infrastructure.Migrations
{
    ...
    [Migration("20240708125430_AddServicesForPosts")]
    partial class AddServicesForPosts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostBooking.Domain.Posts.PostService", b =>
                {
            ...
            modelBuilder.Entity("PostBooking.Domain.Posts.Service", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PostBooking.Domain.Posts.PostService", b =>
                {
                    ...
                    b.HasOne("PostBooking.Domain.Posts.Service", "Service")
                        .WithMany("PostServices")
